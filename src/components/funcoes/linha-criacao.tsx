...
import { criarFuncaoAction } from "@/src/server/actions/funcao";
import {
...
// (#create-funcoes, linhas 1283-1291). Um único campo de texto (`descricao`)
...
export function LinhaCriacao({
  ...
  return (
    <tr className="form-row" id="create-funcoes">
      <td colSpan={3}>
        <div className="form-row-label">Nova função</div>
        {erro ? <div className="form-error">{erro}</div> : null}
        <form action={formAction}>
          <div className="inline-form">
            <div className="f">
              <label htmlFor="fc-descricao">Descrição</label>
              <input
                id="fc-descricao"
                name="descricao"
                type="text"
            ...
            <div className="f">
              <label htmlFor="fc-status">Status</label>
              <select id="fc-status" name="status" required defaultValue="Ativo">
